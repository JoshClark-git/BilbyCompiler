...
public class Parser {
	...
	private ParseNode parseComparisonExpression() {
		...
		if(nowReading.isLextant(Punctuator.GREATER) || nowReading.isLextant(Punctuator.LESSER)) {
	...
	private ParseNode parseAdditiveExpression() {
		...
		while(nowReading.isLextant(Punctuator.ADD, Punctuator.SUBTRACT, Punctuator.MULTIPLY, Punctuator.DIVIDE)) {
